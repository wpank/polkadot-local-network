...
# This should make the node be unresponsive, resulting in getting kick and/or slashed for liveness
...
echo "Removing ImOnline Keys"
docker container exec -it staking-ops-tools_node_charlie_1 rm /data/chains/local_testnet/keystore/${IMONLINE::-1}
echo "Done"

echo "Removing Grandpa Keys...."
docker container exec -it staking-ops-tools_node_charlie_1 rm /data/chains/local_testnet/keystore/${GRANDPA::-1}
echo "Done"
...
echo "Removing Parachain ID Keys..."
docker container exec -it staking-ops-tools_node_charlie_1 rm /data/chains/local_testnet/keystore/${PARA::-1}
echo "Done"

echo "Removing Authority Discovery Keys"
docker container exec -it staking-ops-tools_node_charlie_1 rm /data/chains/local_testnet/keystore/${AUDI::-1}
echo "Done"
echo '------------------------------------------------------------------------------------------------'
